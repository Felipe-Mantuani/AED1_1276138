...
Data        : 31/08/2026
Descricao   : Verificar se um tabuleiro de Sudoku é válido.
...
Dificuldade : A logica da verificacao por blocos de 3x3 e alocar dinamicamente a matriz
...
int main() {
    ...
    int n, numeros[10], valido;
    int **sudoku;
    //alocando dinamicamente a matriz 9x9
